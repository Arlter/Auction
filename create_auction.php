...
// (Uncomment this block to redirect people without selling privileges away from this page)
  ...
  if ($_SESSION["logged_in"] == false || !isset($_SESSION["account_type"]) || $_SESSION["account_type"] != "seller") {
    ...
    <div class="card-body">
      ...
      <form method="post" action="create_auction_result.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" name="auctionDetails" id="auctionDetails" maxlength="2000" rows="4" placeholder="Enter description here..."><?php echo $_SESSION["auction_details"];?></textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
	        <div class="input-group">
              ...
              <input type="number" class="form-control" step="0.10" name="auctionStartPrice" id="auctionStartPrice" value="<?php echo $_SESSION["auction_start_price"];?>" required>  <!-- REVIEW: I set step=0.10 for now-->
            </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <input type="number" class="form-control" step="0.10" name="auctionReservePrice" id="auctionReservePrice" value="<?php echo $_SESSION["auction_reserve_price"];?>">  <!-- optional-->
            </div>
